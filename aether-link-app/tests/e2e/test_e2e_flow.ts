...
async function main() {
  ...
  console.log("Waiting for Agent to download good zip, restart, and register as version 0.1.7...");
  const updatedDevice = await waitAgentOnline("0.1.7", rolledBackPid || undefined);
