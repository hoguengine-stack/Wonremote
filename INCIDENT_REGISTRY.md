...
- Diagnostic launcher guard: The CMD launcher retrieves its matching collector script when absent and stops with a visible error before attempting PowerShell -File.
