...
- Status: Source repairs and focused regression checks passed. A non-public 0.1.106 test candidate and installation only on 82220F6D are now authorized; CI build and installation remain pending.
...
- Release proof: No public deployment is authorized. Candidate preparation aligns version 0.1.106 and passed 238 changed-boundary tests plus TypeScript; exact-main CI build, artifact trust verification and test-device installation remain pending.
...
- Remaining blocker: Build/install the correction, then verify Agent icon, Korean IME, lock-to-PIN-to-unlock live frames and input without a device-list refresh, exact tray restart sequence, and a large-file pause/resume/cancel/final-save cycle between two Windows PCs. Android remains out of scope.
